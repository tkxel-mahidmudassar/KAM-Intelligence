...
- Account History with Tkxel: use uploaded SOWs/proposals/previous KYC briefs, touchpoints, QBRs, and project documents.
...
- Company Financials: use Crunchbase/SEC EDGAR-style public context, account ARR/funding/renewal data, invoices/contract value, revenue concentration, and dependency.
- Engagement History: use uploaded SOWs/proposals/project documentation, touchpoints, meetings, escalations, migrations, timelines, service lines, team composition, and in-house vs outsourced context.
...
const SECTION_SOURCE_FALLBACKS: Record<string, string> = {
  executiveSummary:     "Generated from completed sourced KYC sections; account score; public intelligence",
  ...
  strategicGoals:       "Uploaded documents; touchpoints; previous KYC/account history",
  riskFactors:          "Health score; active signals; KPIs; account context",
  expansionOpportunity: "Whitespace signals; public intelligence; KAM/account context",
  ...
  financialOverview:    "ARR/contract data; public financial/company sources",
};
...
[
  ...
  const promptB = `You are a senior KYC research and document authoring agent. Using the training rubric, account context, public intelligence, documents, and key facts, draft a complete sourced KYC.
