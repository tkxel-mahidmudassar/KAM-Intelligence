...
export const v2AgentBehaviorRules = [
  "Source priority: Salesforce mock data > prior account data > uploaded documents > user-entered data. Once a user approves a value, that approved value becomes the winning value.",
