...
- Account KPI scoring uses the POC scoring model. The UI may display scores on a 1-5 scale, but proposed scores and explanations must follow the POC KPI definitions and weightings.
- The standard KPI dimensions are CSAT Score (20%), Relationship Score (15%), Risk Score (15%), Contract Health Score (15%), Project Health Score (10%), Resource Health Score (10%), Financial Score (10%), and Whitespace Analysis (5%).
