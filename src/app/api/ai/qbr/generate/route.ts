...
export async function POST(req: NextRequest) {
  try {
    ...
    const prompt = `You are a KAM Intelligence engine. Generate a structured ${sessionType} (${sessionType === "QBR" ? "Quarterly Business Review" : sessionType === "DBR" ? "Daily Business Review" : "Executive Business Review"}) agenda for the account below.
