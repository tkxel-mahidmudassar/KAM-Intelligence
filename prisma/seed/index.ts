...
async function main() {
  ...
  await prisma.aIPulseInsight.createMany({
    data: [
      // Critical risks
      {
        ...
        title: "Helix Payments: 81% churn probability — escalate now",
        summary: "Convergence of collapsed NPS (11), 140% ticket surge, and 55-day contract expiry creates a near-certain churn scenario without immediate executive intervention. Sarah Chen must schedule an exec call within 48 hours.",
        confidence: 0.94,
      ...
      },
      {
        ...
        title: "Crestline Capital: 60% of tickets trace to one module",
        summary: "Ticket metadata analysis shows 25 of 41 open tickets reference components in the portfolio analytics module (v2.1, released 5 weeks ago). A focused hotfix sprint could resolve the majority within 8 business days, stabilising the account ahead of renewal discussions in 130 days.",
        confidence: 0.89,
        model: "gemini-2.0-flash",
        promptTokens: 2150,
        outputTokens: 410,
      ...
      // Opportunities
      {
        ...
        title: "Ironclad Logistics: €200K Eastern Europe expansion ready to close",
        summary: "Ironclad's Eastern Europe expansion aligns directly with Tkxel's delivery capability across Poland, Czech Republic, Hungary, and Romania. Budget approval is likely before Q2 close. A tailored proposal this week could lock in the largest expansion deal in the portfolio.",
        confidence: 0.86,
        model: "gemini-2.0-flash",
        promptTokens: 1580,
        outputTokens: 290,
      ...
      },
      {
        accountId: beacon.id,
        type: InsightType.OPPORTUNITY,
        title: "Beacon Analytics: Enterprise upgrade is a $130K no-brainer",
        summary: "Beacon has exceeded growth tier limits for 3 consecutive months. CEO has signalled upgrade intent in the Q1 QBR. Pairing the enterprise proposal with SOC2 support and a dedicated CSM removes all remaining friction — this should close within 30 days.",
        confidence: 0.90,
        model: "gemini-2.0-flash",
        promptTokens: 1340,
        outputTokens: 265,
      ...
      // Trend insight
      {
        ...
        title: "ClearBridge: MAU decline is an onboarding problem, not a satisfaction problem",
        summary: "Cross-referencing ticket content and MAU cohort data shows the decline is concentrated in clinical staff who joined after the v4 interface launch. Targeted 2-week onboarding sprint could recover 12–15% MAU and prevent the account crossing into CRITICAL territory.",
        confidence: 0.78,
        model: "gemini-2.0-flash",
        promptTokens: 2010,
        outputTokens: 395,
      ...
      // Portfolio-wide
      {
        ...
        title: "Portfolio alert: $2.95M ARR at renewal risk in the next 130 days",
        summary: "Helix Payments (55 days, CRITICAL) and Crestline Capital (130 days, AT_RISK) together represent $2.95M ARR. A coordinated renewal task force — rather than siloed KAM efforts — would significantly improve win rates on both accounts. Recommend a joint exec review this week.",
        confidence: 0.96,
        model: "gemini-2.0-flash",
        promptTokens: 2260,
        outputTokens: 460,
      ...
      // Additional insights
      {
        accountId: helix.id,
        type: InsightType.RECOMMENDATION,
        title: "Helix Payments: Assign dedicated support engineer immediately",
        summary: "With 52 open tickets and a named support engineer commitment in the renewal proposal, pre-emptively assigning the engineer today removes a negotiation obstacle and demonstrates good faith ahead of the emergency QBR. It also signals to Jordan Walsh that Tkxel is acting, not just talking.",
        confidence: 0.88,
        model: "gemini-2.0-flash",
        promptTokens: 1640,
        outputTokens: 290,
      ...
      },
      {
        accountId: crestline.id,
        type: InsightType.RISK,
        title: "Crestline Capital: FCA compliance deadline adds renewal complexity",
        summary: "Rebecca Stone (Head of Compliance) flagged that the delayed FCA reporting module creates regulatory exposure. If unresolved by the renewal window, Crestline may use this as leverage for pricing concessions or, at worst, trigger-exit clauses. Resolve before the EBR.",
        confidence: 0.82,
        model: "gemini-2.0-flash",
        promptTokens: 1780,
        outputTokens: 340,
      ...
      },
      {
        accountId: ironclad.id,
        type: InsightType.OPPORTUNITY,
        title: "Ironclad Logistics: Customs compliance module is a €80K quick win",
        summary: "Lena Hofer confirmed Phase 2 interest in the cross-border customs compliance module during the Q1 QBR. With the Eastern Europe expansion underway, this module directly solves an immediate operational pain — requirements scoping should begin in parallel with the expansion proposal.",
        confidence: 0.79,
        model: "gemini-2.0-flash",
        promptTokens: 1510,
        outputTokens: 280,
      ...
      },
      {
        accountId: beacon.id,
        type: InsightType.OPPORTUNITY,
        title: "Beacon Analytics: EMEA expansion — Tkxel's competitive window is now",
        summary: "Beacon's EMEA expansion is planned for H2 2025 following their Series A close. Tkxel's London network and European delivery capability makes this a uniquely strong fit. A proactive EMEA support proposal — even before the enterprise upgrade closes — positions Tkxel as a long-term strategic partner rather than just a vendor.",
        confidence: 0.84,
        model: "gemini-2.0-flash",
        promptTokens: 1620,
        outputTokens: 310,
      ...
      },
      {
        accountId: null,
        type: InsightType.ANOMALY,
        title: "Portfolio pattern: Healthy accounts have NPS > 65; at-risk accounts < 32",
        summary: "Clear NPS threshold separates healthy from at-risk accounts in the portfolio. Ironclad (74) and Beacon (83) vs Helix (11) and Crestline (25). ClearBridge at 30 is the swing account. A 10-point NPS improvement programme for ClearBridge would reduce its AT_RISK probability by an estimated 40%.",
        confidence: 0.91,
        model: "gemini-2.0-flash",
        promptTokens: 2080,
        outputTokens: 390,
  ...
  console.log("✅  AI Pulse Insights created");
